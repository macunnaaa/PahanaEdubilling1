...
<%
    ...
    Item item = (Item) request.getAttribute("itemToEdit");
%>
<!DOCTYPE html>
<html>
<head>
...
<body>
    ...
    <div class="d-flex">
        ...
        <div class="main-content">
            ...
            <div class="p-4">
                <div class="mb-4 pt-3">
                    <p class="text-muted">Update the details for the selected item below.</p>
                </div>
                    ...
                    <div class="card-body p-4 p-md-5">
                        <form action="updateItem" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="itemCode" name="itemCode" class="form-control" value="<%= item.getItemCode() %>" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mt-4">
                                <button type="submit" class="btn btn-warning shadow-sm"><i class="fas fa-sync-alt me-2"></i>Update Item</button>
