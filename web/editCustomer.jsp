...
<%
    ...
    Customer customer = (Customer) request.getAttribute("customerToEdit");
%>
<!DOCTYPE html>
<html>
<head>
...
<body>
    ...
    <div class="d-flex">
        ...
        <div class="main-content">
            ...
            <div class="p-4">
                <div class="mb-4 pt-3">
                    <p class="text-muted">Update the details for the selected customer below.</p>
                </div>
                    ...
                    <div class="card-body p-4 p-md-5">
                        <form action="updateCustomer" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="accountNumber" name="accountNumber" class="form-control" value="<%= customer.getAccountNumber() %>" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="address" name="address" class="form-control" value="<%= customer.getAddress() %>">
                            </div>
                            <div class="mb-4">
                                <label for="telephoneNumber" class="form-label fw-bold">Telephone Number</label>
                                <input type="text" id="telephoneNumber" name="telephoneNumber" class="form-control" value="<%= customer.getTelephoneNumber() %>">
                            </div>
                            <div class="mt-4">
                                <button type="submit" class="btn btn-warning shadow-sm"><i class="fas fa-sync-alt me-2"></i>Update Customer</button>
